...
class SurajKundVisitActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_suraj_kund_visit)

        var location =
            "https://www.google.com/maps?q=Surajkund+Haryana&um=1&ie=UTF-8&sa=X&ved=2ahUKEwjixMuww438AhW3gtgFHQvYBwEQ_AUoAXoECAEQAw";
