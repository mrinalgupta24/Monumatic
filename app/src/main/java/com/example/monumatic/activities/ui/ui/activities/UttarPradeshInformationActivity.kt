...
import com.example.monumatic.activities.ui.ui.adapter.UttarPradeshAdapter
import com.example.monumatic.activities.ui.ui.models.Monuments
import kotlinx.android.synthetic.main.activity_registration.*

class UttarPradeshInformationActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_uttar_pradesh_information)

        imageId = arrayOf(
            R.drawable.taj_mahal,
            R.drawable.agrafort,
            R.drawable.fatehpursikri,
            R.drawable.akbarstomb
        )
    ...
    private fun getUserData() {
        ...
        newRecylerview.adapter = UttarPradeshAdapter(newArrayList)
